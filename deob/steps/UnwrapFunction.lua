...
function UnwrapFunction:new() return setmetatable({}, self) end
...
local function unwrap_once(ast)
  ...
  if base and base.kind == Ast.AstKind.FunctionCallExpression
  and base.base and base.base.kind == Ast.AstKind.FunctionLiteralExpression then
